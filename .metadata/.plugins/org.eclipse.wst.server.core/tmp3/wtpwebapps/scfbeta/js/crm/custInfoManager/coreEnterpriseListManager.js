$(document).ready(function() {
	...
	$('#btn_add').click(function () {
		window.location.href = "/scfbeta/crm/custInfoManager/coreEnterpriseInfoManager.html";
...
window.operateEvents = {
	'click .modify' : function(e, value, row, index) {
		window.location.href = "/scfbeta/crm/custInfoManager/coreEnterpriseInfoManager.html?corpId=" + row.corpId;
