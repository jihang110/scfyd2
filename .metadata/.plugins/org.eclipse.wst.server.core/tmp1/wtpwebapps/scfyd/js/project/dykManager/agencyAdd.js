	      ...
	      fields: {
	          ...
	          maxCreditAmount: {
	              validators: {
	                  ...
	                  callback: {  
	                         message: '前2年度提车数量在0~1000000000之间',  
	          ...
	          firstTwoYearsRetailNum: {
	              validators: {
	                  ...
	                  callback: {  
	                         message: '前2年度零售数量在0~1000000000之间',  
	                         callback: function(value, validator) { 
	                        	 return value =="" || (parseFloat(value)>=0&&parseFloat(value)<=999999999.99);
	                         }  
	                     } 
	          ...
	          firstTwoYearsSaleRank: {
	              validators: {
	                  ...
	                  callback: {  
	                         message: '前2年度销售排名在0~1000000000之间',  
	                         callback: function(value, validator) { 
	                        	 return value =="" || (parseFloat(value)>=0&&parseFloat(value)<=999999999.99);
	                         }  
	                     } 
	          ...
	          thisYearPlanPickupNum: {
	              validators: {
	                  ...
	                  callback: {  
	                         message: '本年度计划提车数量在0~1000000000之间',  
	                         callback: function(value, validator) { 
	                        	 return value =="" || (parseFloat(value)>=0&&parseFloat(value)<=999999999.99);
	                         }  
	                     } 
	          ...
	          thisYearPlanSales: {
	              validators: {
	                  ...
	                  callback: {  
	                         message: '本年度计划销售额在0~1000000000之间',  
	                         callback: function(value, validator) { 
	                        	 return value =="" || (parseFloat(value)>=0&&parseFloat(value)<=999999999.99);
	                         }  
	                     } 
