...
function initTable() {
    ...
    $("#marginListTable").bootstrapTable({
        ...
        columns: [{
            ...
            valign: 'middle',
            formatter:function (value,row) {
                return $.number(parseInt(row.payActGuarantee)-parseInt(row.payAbleGuarantee),2);
            }
        },{
            field: 'operation',
            title: '详情',
...
window.operateEvents = {
    'click .detail': function(e, value, row, index) {
    	var guaranteeBalance = parseInt(row.payActGuarantee)-parseInt(row.payAbleGuarantee);
