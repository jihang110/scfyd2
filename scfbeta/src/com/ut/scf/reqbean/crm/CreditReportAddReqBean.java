...
public class CreditReportAddReqBean extends BaseReqBean{
    ...
    private String relaEnterpriseId;
	...
	public String getRelaEnterpriseId() {
		return relaEnterpriseId;
	}
	public void setRelaEnterpriseId(String relaEnterpriseId) {
		this.relaEnterpriseId = relaEnterpriseId;
	}
