...
import com.ut.scf.respbean.bpm.FlowProTuningRespBean;
...
public class PackageManagerServiceImpl implements IPackageManagerService{
	...
	@Resource private FlowProTuningMapper flowProTuningMapper;
	...
	@Override
	@Transactional(readOnly = true)
	public BaseRespBean selectProjectInfo(Map<String, Object> paramMap) {
		List<Map<String, Object>> list = flowProTuningMapper.selectFlowProTuning(paramMap);
		BaseRespBean respBean = new FlowProTuningRespBean();
		if (CollectionUtils.isNotEmpty(list)) {
			BeanUtil.mapToBean(list.get(0), respBean);
		}
		return respBean;
	}
