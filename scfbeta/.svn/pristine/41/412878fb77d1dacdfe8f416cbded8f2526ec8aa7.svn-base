...
public class CreditReportServiceImpl implements ICreditReportService {
	...
	public BaseRespBean getCorpCreditReportList(Map<String, Object> paramMap, PageInfoBean page) {
		List<Map<String, Object>> list = creditReportDao.selectCorpCreditReportList(paramMap, page);
	...
	@Override
	@Transactional(readOnly = true)
	public BaseRespBean getShareHolderCreditReportList(Map<String, Object> paramMap, PageInfoBean page) {
		List<Map<String, Object>> list = creditReportDao.selectShareHolderCreditReportList(paramMap, page);
		PageRespBean respBean = new PageRespBean();
		respBean.setPages(page.getTotalPage());
		respBean.setRecords(page.getTotalRecord());
		respBean.setDataList(list);
