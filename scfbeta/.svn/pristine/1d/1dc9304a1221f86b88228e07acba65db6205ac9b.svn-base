...
public class OrgnLoanCount {
	...
	public String toString() {
		return "OrgnLoanCount [recUid=" + recUid + ", corpId=" + corpId
				+ ", loanDate=" + loanDate + ", dueDate=" + dueDate
				+ ", loanBank=" + loanBank + ", assureCompany=" + assureCompany
				+ ", cautionMoney=" + cautionMoney + ", loanMoney=" + loanMoney
				+ ", profitRate=" + profitRate + ", pawn=" + pawn
